            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://lh3.googleusercontent.com/a/ACg8ocLMbw8R1rEjr1a5NhSNT6zbdMX9uRCs57EDK8mplAOCl4U=s96-c"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Eli Rosenfeld</div>
